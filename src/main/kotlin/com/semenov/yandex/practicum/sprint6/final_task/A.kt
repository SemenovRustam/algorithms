 ...
 * Фильтрация и добавление рёбер в edges: 0(E log V) - тк мы проходим по кол-ву ребер,
 * на каждом шаге из кучи достаем максимальный элемент, а кол-во таких ребер будет равняться кол-ву вершин графа.
 *
 * getMaxMst():
