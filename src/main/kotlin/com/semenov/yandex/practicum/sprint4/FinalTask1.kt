...
Общая: построение индекса + результат = (d*d_w) + (q_w*d+1) * q
получается d_w и q_w сокращаем так как они сильно меньше документов и запросов,
получается d + d * q = 2d*q = 2 сокращаем = d * q
