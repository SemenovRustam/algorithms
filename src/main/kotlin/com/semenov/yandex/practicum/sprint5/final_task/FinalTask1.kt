...
/**
 * https://contest.yandex.ru/contest/24810/run-report/119999997/
 *  Принцип работы:
 ...
 *  Сортирую список:
    ...
    на каждой итерации метод swap(0, i) меняет максимальный элемент кучи под индексом 0 с текущим рассматриваемым элементом
    массива, далее вызывается метод просеивание кучи, который восстанавливает свойство кучи.
    Т.к на каждой итерации наибольший элемент перемешается в конец рассматриваемого массива - в конце цикла массив будет
