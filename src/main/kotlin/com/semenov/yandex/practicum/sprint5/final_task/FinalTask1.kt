 ...
 *  for (i in size - 1 downTo 1) {
    ...
    на каждой итерации метод свап меняет максимальный элемент кучи под индексом 0 с текущим рассматриваемым элементом
    массива, далее вызывается просеивание кучи, которая восстанавливает свойство кучи.
