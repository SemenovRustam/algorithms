...
/**
  https://contest.yandex.ru/contest/24810/run-report/119914217/
  Принцип работы:
  ...
  Если искомый ключ меньше значения в корне деерва - тогда вызываем рукурсивно функцию remove  для левого поддерева.
  Если искомое значение больше значения корня - тогда вызываем ф-ию  remove с правым поддеревом.
